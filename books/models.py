...
class Book(models.Model):
    ...
    # 作者ID,外键关联
    author = models.ForeignKey(Author, to_field='author_id', on_delete=models.CASCADE, related_name='books')
    # 书名
    ...
    # 热度
    hot_rank = models.IntegerField(blank=False, default=999)
    # 详情(全)
    full_desc = models.TextField(blank=False, null=False, default='')
